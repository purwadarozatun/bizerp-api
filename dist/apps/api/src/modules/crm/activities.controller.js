...
let ActivitiesController = class ActivitiesController {
    ...
    findAll(user, type, contactId, page, pageSize) {
...
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'List activities with optional filters' }),
...
__decorate([
    (0, common_1.Get)('timeline/:contactId'),
    (0, swagger_1.ApiOperation)({ summary: 'Get interaction timeline for a contact' }),
...
__decorate([
    (0, common_1.Post)(),
    (0, swagger_1.ApiOperation)({ summary: 'Log a new activity' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Mark an activity as completed' }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
...
exports.ActivitiesController = ActivitiesController = __decorate([
    (0, swagger_1.ApiTags)('crm/activities'),
